import React, { createContext, useRef, useEffect, useReducer, useState, useMemo, useCallback, useContext } from 'react';
...
var useGunNamespace = function useGunNamespace(gun, soul) {
  var _useState2 = useState(gun && soul ? gun.user(soul) : gun ? gun.user() : null),
...
var useGunCollectionStatePaginated = function useGunCollectionStatePaginated(ref, paginationOpts) {
  ...
  var _useState11 = useState(initialPage),
  ...
  var setCachedPage = useCallback(function (page, items) {
